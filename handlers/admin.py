...
import sqlite3
from .sqlit import info_members,cheak_traf,obnovatrafika1,obnovalinka,obnovatrafika2,obnovatrafika3
...
ADMIN_ID_1 = 1035355655 #Артем
ADMIN_ID_2 = 1271901549 # Второй аккаунт заказчика
ADMIN2 = 494588959

ADMIN_ID =[ADMIN_ID_1,ADMIN2,ADMIN_ID_2]
